...
exportgraphics(gcf, 'BEV_speed.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_motorPower.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_SOC.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_temperature.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_efficiency.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_compressorWork.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_cabHeater.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_compressorCOOP.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'BEV_pressureRatio.pdf', 'ContentType', 'vector')

...
exportgraphics(gcf, 'FCHEV_powers.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'FCHEV_FCtempvstime.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'FCHEV_SOC.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'FCHEV_condenserTemperature.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'FCHEV_fuelCellTemperature.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'FCHEV_COOP.pdf', 'ContentType', 'vector')
...
exportgraphics(gcf, 'FCHEV_pressureRatio.pdf', 'ContentType', 'vector')